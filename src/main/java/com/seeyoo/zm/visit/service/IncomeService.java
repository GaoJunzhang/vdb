...
public class IncomeService {
    ...
    public Page<VisitStatisBean> findIncomeDailysByPage(PageParam pageParam, Timestamp start, Timestamp end) {
        ...
        if(pageParam != null) { //分页
            ...
            return new PageImpl<VisitStatisBean>(incomeDailyList);
        }
    }
    /**
     * 给hql参数设置值
